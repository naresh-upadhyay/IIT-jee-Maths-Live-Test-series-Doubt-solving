...
public class Basic_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView = findViewById(R.id.adViewbasic);
        ...
        final SharedPreferences.Editor edt = prefAdmin.edit();
        edt.putBoolean(pdfUrl+"read",true);
        edt.apply();
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(PDFTools.isDownloadManagerAvailable(Basic_activity.this) ){
                    PDFTools.showPDFUrl(Basic_activity.this,titleNoti, pdfUrl);
                }
                else{
    ...
    private void popUpShareImage(final File imageFile, final boolean shareCheck) {
        ...
        SubsamplingScaleImageView  imageView=(SubsamplingScaleImageView)myDialog.findViewById(R.id.shareImage);
        Bitmap ssbitmap = BitmapFactory.decodeFile(imageFile.getAbsolutePath());
        imageView.setImage(ImageSource.bitmap(ssbitmap));
