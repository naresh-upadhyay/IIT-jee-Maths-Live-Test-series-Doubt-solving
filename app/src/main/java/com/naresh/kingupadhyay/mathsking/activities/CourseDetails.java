...
public class CourseDetails extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean flagval = bundle.getBoolean("flag",true);
        ...
        favouritesLoad(progressbar,query);
    ...
    public void favouritesLoad(final AVLoadingIndicatorView progressbar,Query query){
