...
import com.naresh.kingupadhyay.mathsking.viewholders.LoadSuggestionsViewHolder;
...
public class Suggestions extends Fragment {
    ...
    private FirestoreRecyclerAdapter<LoadDoubts, LoadSuggestionsViewHolder> adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CollectionReference chaptersRef = db
                ...
                .collection("suggestions");//.document("course")
        queryMain = chaptersRef.orderBy("votes",Query.Direction.DESCENDING).limit(300);
//        queryMain = chaptersRef.orderBy("uploadingTime",Query.Direction.ASCENDING).limit(50);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!skip){
                    ...
                    intent.putExtra("tab","suggestions");
    ...
    public void addExampleCard(Query query,RecyclerView recyclerView){
        ...
        adapter = new FirestoreRecyclerAdapter<LoadDoubts, LoadSuggestionsViewHolder>(options){

            @Override
            protected void onBindViewHolder(@NonNull final LoadSuggestionsViewHolder holder, int position, @NonNull LoadDoubts model) {
            ...
            @NonNull
            @Override
            public LoadSuggestionsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ask_solve_doubts_card_view, parent, false);
                return new LoadSuggestionsViewHolder(view);
            }
        };
