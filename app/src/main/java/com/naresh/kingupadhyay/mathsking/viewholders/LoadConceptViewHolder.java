...
public class LoadConceptViewHolder extends RecyclerView.ViewHolder {
    private View view;
    private int topic;
...
//    private String KEY;
    ...
    public LoadConceptViewHolder(View itemView) {
        super(itemView);
        view = itemView;
                    ...
                    case R.id.delete_popup :
                        try {
                            ...
                            final DocumentReference upcomingRef = db
                                    ...
                                    .collection("concepts").document(documentId);
                            upcomingRef.delete();
                        }catch (Exception e){
                        }
                        break;
