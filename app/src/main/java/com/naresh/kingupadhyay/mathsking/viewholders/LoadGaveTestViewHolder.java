...
public class LoadGaveTestViewHolder extends RecyclerView.ViewHolder {
    private View view;
...
//    private boolean dcheckval=false;
    ...
    public LoadGaveTestViewHolder(View itemView, final int[] marksValueAll) {
        super(itemView);
        view = itemView;
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if(!option){
                    edt.putInt(documentId+"s",i);
                    edt.apply();

                    int spinNumber = CountryData.numberCodes[i];
                    if(spinNumber==numericval){
                        marksValueAll[cardnumber-1] = markspos;
                        edt.putInt(documentId,markspos);
                        edt.apply();

                    }else if(spinNumber==-1){
                        marksValueAll[cardnumber-1] = 0;
                        edt.putInt(documentId,0);
                        edt.apply();
                    }else{
                        marksValueAll[cardnumber-1] = marksneg;
                        edt.putInt(documentId,marksneg);
                        edt.apply();
                    }
        ...
        if(id.equals("vinayupadhyay02001@gmail.com") || id.equals("naresh03961999@gmail.com") || id.equals("rakshitaupadhyay1497@gmail.com") ) {
            part3Rl.setVisibility(View.VISIBLE);//todo make visible after test
        }else{
            part3Rl.setVisibility(View.GONE);
        }
        ...
        checkBoxA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                boolean b = checkBoxA.isChecked();
//                acheckval=b;
                edt.putBoolean(documentId+"a",b);
                edt.apply();
                checkBoxA.setButtonDrawable(b ? R.drawable.checkbox_tick : R.drawable.checkbox_empty);
                ...
                marksValueAll[cardnumber-1] = marksCalculation();
        ...
        checkBoxB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                boolean b = checkBoxB.isChecked();
//                bcheckval = b;
                edt.putBoolean(documentId+"b",b);
                edt.apply();
                checkBoxB.setButtonDrawable(b ? R.drawable.checkbox_tick : R.drawable.checkbox_empty);
        ...
        checkBoxC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                boolean b = checkBoxC.isChecked();
//                ccheckval = b;
                edt.putBoolean(documentId+"c",b);
                edt.apply();
                checkBoxC.setButtonDrawable(b ? R.drawable.checkbox_tick : R.drawable.checkbox_empty);
        ...
        checkBoxD.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                boolean b = checkBoxD.isChecked();
//                dcheckval = b;
                edt.putBoolean(documentId+"d",b);
                edt.apply();
                checkBoxD.setButtonDrawable(b ? R.drawable.checkbox_tick : R.drawable.checkbox_empty);
    ...
    private int marksCalculation(){
        ...
        if(checka||checkb||checkc||checkd){
            if((checka == optionA) && (checkb == optionB) && (checkc == optionC) && (checkd == optionD) ){
                return markspos;
            }else {
                if(checka){
                    if(checka!=optionA){
                ...
                return (int)(markspos*1.0*(tempMarks*1.0/4*1.0));
            }
        }else{
            return 0;
        }
    ...
    public void setCardnumber(int cardnumberin) {
        ...
        spinner.setSelection(prefs.getInt(documentId+"s",0));
        checkBoxA.setSelected(checka);
        checkBoxB.setSelected(checkb);
        checkBoxC.setSelected(checkc);
        checkBoxD.setSelected(checkd);
        checkBoxA.setButtonDrawable(checka ? R.drawable.checkbox_tick : R.drawable.checkbox_empty);
        CompoundButtonCompat.setButtonTintList(checkBoxA, checka ? ColorStateList.valueOf(view.getResources().getColor(R.color.blue)) :ColorStateList.valueOf(view.getResources().getColor(R.color.black)));

        checkBoxB.setButtonDrawable(checkb ? R.drawable.checkbox_tick : R.drawable.checkbox_empty);
        CompoundButtonCompat.setButtonTintList(checkBoxB, checkb ? ColorStateList.valueOf(view.getResources().getColor(R.color.blue)) :ColorStateList.valueOf(view.getResources().getColor(R.color.black)));

        checkBoxC.setButtonDrawable(checkc ? R.drawable.checkbox_tick : R.drawable.checkbox_empty);
        CompoundButtonCompat.setButtonTintList(checkBoxC, checkc ? ColorStateList.valueOf(view.getResources().getColor(R.color.blue)) :ColorStateList.valueOf(view.getResources().getColor(R.color.black)));

        checkBoxD.setButtonDrawable(checkd ? R.drawable.checkbox_tick : R.drawable.checkbox_empty);
        CompoundButtonCompat.setButtonTintList(checkBoxD, checkd ? ColorStateList.valueOf(view.getResources().getColor(R.color.blue)) :ColorStateList.valueOf(view.getResources().getColor(R.color.black)));
    ...
    public void setNumericval(final int numericval) {
